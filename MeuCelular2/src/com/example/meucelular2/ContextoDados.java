...
public class ContextoDados extends SQLiteOpenHelper {
	...
	/** A versÃ£o da base de dados que esta classe compreende. */
	private static final int VERSAO_BD = 2;
	private static final String LOG_TAG = "Agenda";
	/** MantÃ©m rastreamento do contexto que nÃ³s podemos carregar SQL */
	...
	{
		Log.w(LOG_TAG, "Atualizando a base de dados da versÃ£o " + oldVersion + " para " + newVersion + ", que destruirÃ¡ todos os dados antigos");
		...
		// Isto Ã© apenas didÃ¡tico. Na vida real, vocÃª terÃ¡ de adicionar novas colunas e nÃ£o apenas recriar o mesmo banco
		onCreate(db);
	}
